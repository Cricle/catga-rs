...
impl Handler<Query> for QueryHandler {
    async fn handle(&self, _: Query) -> CatgaResult<String> {
...
impl Handler<Heavy> for HeavyHandler {
    async fn handle(&self, _: Heavy) -> CatgaResult<String> {
        Ok("heavy".to_string())
    }
}
...
fn print_struct_sizes() {
    ...
    println!(
        "QueryHandler: {} bytes",
        std::mem::size_of::<QueryHandler>()
    );
    println!(
        "HeavyHandler: {} bytes",
        std::mem::size_of::<HeavyHandler>()
    );
}
...
fn zero_sized_types() {
    ...
    println!(
        "PingHandler is ZST: {}",
        std::mem::size_of::<PingHandler>() == 0
    );
    println!(
        "QueryHandler is ZST: {}",
        std::mem::size_of::<QueryHandler>() == 0
    );
    println!(
        "HeavyHandler is ZST: {}",
